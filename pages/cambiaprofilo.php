...
<html lang="en">
<head>
    <link rel="stylesheet" href="../css/styleCambiaProfilo.css">
    <meta charset="UTF-8">
...
<body>
    <div class="wrapper">
        <form action="pages/modificaProfilo.php" method="post">
            ...
            <div class="input-box">
            <input type="text" id="biografia" name="biografia" placeholder="Biografia"><br>
            </div>
            <input type="submit" class="btn" value="Modifica Dettagli">
            <div class="sbagliato">
